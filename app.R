...
text.box <- tabBox(id = "tabset1", height = "350px", width = 20,
                  tabPanel('Intro', span("Since the start of the COVID-19 pandemic in the UK, visits to outdoor parks and spaces have become even more valuable to the public. Getting outdoors allows us to maintain good physical and mental health in otherwise isolated times. However, the lack of alternative recreational opportunities during the pandemic means that parks are becoming busier - potentially making them hotspots for COVID-19 transmission. In order to help you understand the benefits and risks of visiting parks during the pandemic, we have created this app. It allows you to visualise how busy parks in your area have been over the course of the pandemic (Google Community Mobility Reports data; https://www.google.com/covid19/mobility/), and experimentally forecasts how busy parks will be over the coming days, using weather data (Met Office) and data on park visiting trends (Natural England) and access to greenspace (e.g. public parks, private gardens; Ordnance Survey).", style = "font-size:18px", width = 12), 
                           span("This is purely experimental - we do NOT take responsibility for any decisions made as a result of using this experimental app. See Disclaimer for more details.", style = "font-size:18px;font-weight:bold;", width = 12)),
                  tabPanel('Bar graph', span("Below you can see a graph of showing the relative busyness of parks on a day of the week (default current day of the week) in a particular district of England (default is Bedford) during the course of the pandemic. On the x axis is the date, on the y axis is the number of visitors to parks - Google data (https://www.google.com/covid19/mobility/) defined in terms of the number of visitors relative the the average (median) number of visitors on that day of the week in the winter period before the start of the pandemic (Jan 3 - Feb 6, 2020). For example, 2x as busy means parks are double as busy as the winter period, 0.5x means they are half as busy.", style = "font-size:18px;"),
                  span("Increases relative to the winter period are in green (e.g. 2x as busy).", style = "color:green; font-weight:bold; font-size:18px;"),
                  span("Decreases relative to the winter period are in grey (e.g. 0.5x as busy).", style = "color:grey; font-weight:bold; font-size:18px;"),
                  span("In white is the forecasted busyness for the next day of the week selected.", style = "color:black; font-weight:bold; font-size:18px;"),
                  span("The pink line is a scaled mean temperature change relative to the winter period.", style = "color:palevioletred; font-weight:bold; font-size:18px;"),
                  span("The blue line is a scaled mean rainfall change relative to winter (Met Office data used to inform the forecast).", style = "color:royalblue; font-weight:bold;font-size:18px;", width = 12)),
                  
                  tabPanel('Map', span("On the right, we see the same historical data (minus the forecast) displayed on a map of all of the Google regions.", style = "font-size:18px;"),
                  span("Darker shades of green represent areas where parks are the most busy compared to the winter period,", style = "color:green; font-weight:bold; font-size:18px;"), 
                  span("white regions represent areas where they are about as busy as winter,", style = "color:black; font-weight:bold; font-size:18px;"), 
                  span("darker shades of grey represent areas where parks are the least busy compared to the winter period.", style = "color:grey; font-weight:bold; font-size:18px;"),
                  span("This map allows you to compare the busyness of your region to others. On the sidebar on the left, you can also select the time period to view on the right, and it will change both the map and the timeline. You can also select the region or day of the week to view on the graph (or all of the data for a region). Enjoy (parks safely)!", style = "font-size:18px;", width = 12)),
