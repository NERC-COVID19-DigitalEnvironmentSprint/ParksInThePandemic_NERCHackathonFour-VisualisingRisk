...
text.box <- tabBox(id = "tabset1", height = "350px", width = 20,
                  ...
                  span("The red line is the temperature change relative to the winter period.", style = "color:red; font-weight:bold; font-size:18px;"),
                  span("The blue line is the rainfall change relative to winter (Met Office data used to inform the forecast).", style = "color:blue; font-weight:bold;font-size:18px;", width = 12)),
