...
text.box <- tabBox(id = "tabset1", height = "350px", width = 20,
                  tabPanel('Intro', 'Since the start of the COVID-19 pandemic in the UK, visits to outdoor parks and spaces have become even more valuable to the public. Getting outdoors allows us to maintain good physical and mental health in otherwise isolated times. However, the lack of alternative recreational opportunities during the pandemic means that parks are becoming busier - potentially making them hotspots for COVID-19 transmission. In order to help you manage the benefits and risks of visiting parks during the pandemic, we have created this app. It allows you to visualise how busy parks in your area have been over the course of the pandemic, and importantly, forecasts how busy parks will be over the coming days, using weather data (Met Office) and data on park visiting trends (Natural England) and access to greenspace (e.g. public parks, private gardens; Ordnance Survey).', style = "font-size:18px;", width = 12),
                  ...
                  span("The red line is the temperature change relative to the winter period.", style = "color:palevioletred; font-weight:bold; font-size:18px;"),
                  span("The blue line is the rainfall change relative to winter (Met Office data used to inform the forecast).", style = "color:royalblue; font-weight:bold;font-size:18px;", width = 12)),
                  ...
                  tabPanel('Credits', 'Content', style = "font-size:18px;", width = 12),
                  tabPanel('Disclaimer', 'Content', style = "font-size:18px;", width = 12)
                  )
